...
async function getFilterCityServicesMln(req, res) {
    try {
        let {city} = req.body;
...
async function getFilterDistrictServicesMln(req, res) {
    try {
...
async function getFilterWardsServicesMln(req, res) {
    try {
...
async function getFilterServicesMln(req, res) {
    try {
        let {search} = req.body;
        let {page, limit} = utils.pagination(req.query, 10)
        await Request.findAndCountAll({
...
async function getFilterStatusServicesMln(req, res) {
    try {
        let {status} = req.body;
        console
        let {page, limit} = utils.pagination(req.query, 10)
...
module.exports = {
    getFilterCityServicesMln,
    getFilterDistrictServicesMln,
    getFilterWardsServicesMln,
    getFilterServicesMln,
    getFilterStatusServicesMln
}
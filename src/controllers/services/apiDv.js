...
async function getFilterCityServicesDv(req, res) {
    try {
        let {city} = req.body;
...
async function getFilterDistrictServicesDv(req, res) {
    try {
...
async function getFilterWardsServicesDv(req, res) {
    try {
...
async function getFilterServicesDv(req, res) {
    try {
        let {search} = req.body;
        let {page, limit} = utils.pagination(req.query, 10)
        await Request.findAndCountAll({
...
async function getFilterStatusServicesDv(req, res) {
    try {
        let {status} = req.body;
        console
        let {page, limit} = utils.pagination(req.query, 10)
...
module.exports = {
    getFilterCityServicesDv,
    getFilterDistrictServicesDv,
    getFilterWardsServicesDv,
    getFilterServicesDv,
    getFilterStatusServicesDv
}
...
async function getFilterCityServicesDh(req, res) {
    try {
        let {city} = req.body;
...
async function getFilterDistrictServicesDh(req, res) {
    try {
...
async function getFilterWardsServicesDh(req, res) {
    try {
...
async function getFilterServicesDh(req, res) {
    try {
        let {search} = req.body;
        let {page, limit} = utils.pagination(req.query, 10)
        await Request.findAndCountAll({
...
async function getFilterStatusServicesDh(req, res) {
    try {
        let {status} = req.body;
        console
        let {page, limit} = utils.pagination(req.query, 10)
...
module.exports = {
    getFilterCityServicesDh,
    getFilterDistrictServicesDh,
    getFilterWardsServicesDh,
    getFilterServicesDh,
    getFilterStatusServicesDh
}